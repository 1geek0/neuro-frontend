  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto py-8">
        ...
        <ErrorBoundary>
          <StoryInput redirectPath="/home" defaultValue={preFilledStory} />
        </ErrorBoundary>
      </div>
    </main>
  );
